...
recieverRoute.get("/single_package/:user_id/:package_id", authenticateJWT, async (req, res) => {
    ...
    delivery_point.address AS delivery_point.address, 
    delivery_point.postal_code AS delivery_point.postal_code, 
    delivery_point.city AS delivery_point.city
FROM 
    package p
JOIN 
